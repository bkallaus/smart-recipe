    ...
    <div className='grid md:grid-cols-3 gap-4 lg:gap-10'>
      {recipes.map((recipe) => (
        ...
        <Link
          ...
          viewTransition
          className='group block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-md h-full'
        >
          <div className='bg-white p-4 rounded-md shadow-md h-full transition-all group-hover:shadow-lg group-hover:-translate-y-1'>
            {/* <img
