    ...
    <div className='grid md:grid-cols-3 gap-4 lg:gap-10'>
      {recipes.map((recipe) => (
        ...
        <Link
          ...
          viewTransition
          className='group block outline-none rounded-md focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2'
        >
          <div className='bg-white p-4 rounded-md shadow-md h-full transition-all duration-200 group-hover:shadow-lg group-hover:-translate-y-1'>
            {/* <img
