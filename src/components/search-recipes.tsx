...
const SearchRecipes = () => {
  ...
  return (
    <div>
            ...
            <div className='flex flex-col w-full relative'>
              <div className='relative'>
                <input
                  ...
                  className='w-full px-5 py-4 pr-14 text-base rounded-xl bg-[hsl(var(--surface-container-lowest)/0.95)] text-[hsl(var(--on-surface))] placeholder-[hsl(var(--on-surface-variant))] outline-none border-0 border-b-2 border-[hsl(var(--outline-variant)/0.3)] focus:border-[hsl(var(--primary))] transition-colors duration-200 shadow-ambient'
                  value={searchTerm}
                ...
                <div className='absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-2'>
                  {isPending ? (
                    ...
                    <button
                      ...
                      className='text-[hsl(var(--on-surface-variant))] hover:text-[hsl(var(--on-surface))] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--primary))] rounded-full p-1'
                      onClick={() => {
                        setSearchTerm('');
                        inputRef.current?.focus();
                      }}
      ...
      {/* Search results */}
      {searchTerm && (value || isPending || recentRecipes.length > 0) ? (
        <div className='px-8 md:px-12 lg:pl-16 lg:pr-8 py-12 bg-[hsl(var(--surface-container-low))]'>
          {isPending ? (
            ...
            <div className='flex justify-center items-center py-12 text-center'>
              <p className='text-lg text-[hsl(var(--on-surface-variant))]'>
